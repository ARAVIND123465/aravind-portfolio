              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-stone-800/50 border border-stone-700 rounded-lg px-4 py-3 text-white text-sm placeholder:text-stone-600 focus:outline-none focus:border-rose-600 transition-colors"
                  />
                </div>
                <div>
                  <label className="font-mono text-[10px] text-stone-500 uppercase tracking-widest mb-2 block">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    className="w-full bg-stone-800/50 border border-stone-700 rounded-lg px-4 py-3 text-white text-sm placeholder:text-stone-600 focus:outline-none focus:border-rose-600 transition-colors resize-none"
                  />
                </div>
                <button
                  type="submit"
                  className="w-full py-3.5 bg-rose-600 hover:bg-rose-700 text-white font-mono text-xs tracking-widest uppercase rounded-lg transition-all flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-rose-900/30"
                >
